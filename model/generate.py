...
def parse_args():
  ...
  parser.add_argument('-mt', '--max_target_length', default=128, type=int)
  # etc
...
def get_output(args, tokenizer, model):
  ...
  for b_index, batch in enumerate(tqdm_loader):
    ...
    predict = model.generate(input_ids=source, decoder_input_ids=target_in, max_length=args.max_target_length)
